...
!(function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n.indexOf("<") >= 0 && n.indexOf(">") >= 0) {
                ...
                s = (function(e, t) {
                    ...
                    for (
                        var a = [], i = t.querySelectorAll(e), s = 0; s < i.length; s += 1
                    )
                        a.push(i[s]);
                    return a;
                })(e.trim(), t || i);
    ...
    var g,
        ...
        b = {
            ...
            trigger: function() {
                for (
                    var e = l(), t = arguments.length, a = new Array(t), i = 0; i < t; i++
                )
                    a[i] = arguments[i];
    ...
    function S() {
        for (
            var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1
        ) {
            var a = t < 0 || arguments.length <= t ? void 0 : arguments[t];
            if (null != a)
                for (
                    var i = Object.keys(Object(a)), s = 0, r = i.length; s < r; s += 1
                ) {
                    var n = i[s],
                        ...
                        if (
                            ...
                            (a.allowClick = !1), !s.cssMode && o.cancelable && o.preventDefault(),
                                ...
                                (s.loop && a.loopFix(),
                                    ...
                                    (i.allowMomentumBounce = !1), !s.grabCursor ||
                            ...
                            if (
                                (s.touchReleaseOnEdges && (y = 0),
                                    ...
                                    g && (o.preventedByNestedSwiper = !0), !a.allowSlideNext &&
                                    "next" === a.swipeDirection &&
                                    i.currentTranslate < i.startTranslate &&
                                    (i.currentTranslate = i.startTranslate), !a.allowSlidePrev &&
    ...
    function D(e) {
        ...
        if (
            ...
            if (i.freeMode) {
                ...
                for (
                    var L = 0, $ = t.slidesSizesGrid[0], I = 0; I < l.length; I += I < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup
                ) {
    ...
    var Y = {
        ...
        R = (function() {
            function t() {
                for (
                    var e, a, i = arguments.length, s = new Array(i), r = 0; r < i; r++
                )
                    s[r] = arguments[r];
                ...
                if ((e = o[0])) {
                    ...
                    return (
                        ...
                        S(n, {
                            ...
                            rtlTranslate: "horizontal" === n.params.direction &&
            ...
            return (
                ...
                (r.slidesPerViewDynamic = function() {
                    ...
                    if (t.centeredSlides) {
                        for (
                            var l, o = a[r].swiperSlideSize, d = r + 1; d < a.length; d += 1
                        )
                            a[d] &&
                            !l &&
    ...
    var W = {
        ...
        q = {
            ...
            create: function() {
                M(this, {
                    virtual: t(
                        t({}, W), {}, { slides: this.params.virtual.slides, cache: {} }
                    ),
                });
            },
            on: {
                ...
                if ((a.transition(e), t.params.virtualTranslate && 0 !== e)) {
                    ...
                    a.transitionEnd(function() {
                        if (!s && t && !t.destroyed) {
                            (s = !0), (t.animating = !1);
                            for (
                                var e = ["webkitTransitionEnd", "transitionend"], a = 0; a < e.length; a += 1
                            )
                                i.trigger(e[a]);
                        }
                    });
                    ...
                    click: function(e, t) {
                        ...
                        !e.params.navigation.hideOnClick ||
                            ...
                            (s ?
                                ...
                                r && (a = r.hasClass(e.params.navigation.hiddenClass)), !0 === a ? e.emit("navigationShow") : e.emit("navigationHide"),
